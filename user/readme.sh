...
1.  Generate a PGP key
    *   Option A
        ...
        Use keybase.io. You can just feed your keybase.io username in to this
        module and we'll do the rest.
...
This section of the documentation is [not currently available](
